...
def get_args_parser():
    ...
    parser.add_argument('--disable_scaleup', action='store_true', default=False,
...
#    parser.add_argument('--input-size', default=224, type=int, help='images input size')
    ...
    parser.add_argument('--initial_checkpoint', type=str, default='./output_multi_GAT/checkpoint30.pth', help='path to the pretrained model') 
...
# create data loaders w/ augmentation pipeiine
    ...
    test_list = os.path.join(args.data_txt_dir, test_list_name)  
    test_augmentor = get_augmentor(False, args.input_size, mean, std, args.disable_scaleup,
    ...
    dataset_test = video_data_cls(args.data_dir, test_list, args.duration, args.frames_per_group,
    ...
    if args.initial_checkpoint:
                ...
                state = evaluate(data_loader_test, model, device, num_tasks, distributed=args.distributed, amp=args.amp, num_crops=args.num_crops, num_clips=args.num_clips)
                print(f"Accuracy of the network on the {len(dataset_test)} test images: {state['acc1']:.1f}%")
